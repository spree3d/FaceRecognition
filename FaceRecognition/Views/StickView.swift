...
struct Stick_Previews: PreviewProvider {
    ...
    static var previews: some View {
        StickProxy(rotation: Float.two_pi * 0.125, opacity: 0.85)
            .previewDisplayName("opacity 0.85")
        StickProxy(rotation: Float.two_pi * 0.25, opacity: 0.50)
            .previewDisplayName("opacity 0.5")
        StickProxy(rotation: Float.two_pi * 0.375, opacity: 0.25)
            .previewDisplayName("opacity 0.25")
        StickProxy(rotation: Float.two_pi * 0.5, opacity: 0.125)
